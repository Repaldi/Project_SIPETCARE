...
<?php 
    ...
    $queryCostumer=mysqli_query($conn, "SELECT * FROM chat ");
    $dataCostumer = mysqli_fetch_array($queryCostumer);
    $costumer_id = $dataCostumer['costumer_id'];  
    ...
    <div class="dasar" id="judul">
        ...
        <div class="chathistory">    
            <?php  
                ...
                $query =mysqli_query($conn, "SELECT * FROM chat WHERE toko_id=$toko_id AND costumer_id=$id");

                while ($baris_data = mysqli_fetch_assoc($query)) {?>
              <?php  $id_costumernya = $baris_data['costumer_id']; ?>
                
                <div <?php if ($baris_data["toko_id"] == $toko_id) { ?> class="kotak_send" <?php 
        ...
        <form id="inputchatbox" action="" method="POST">
            ...
            <input type="hidden" name="costumer_id" value="<?php echo $id_costumernya ?>"/>
