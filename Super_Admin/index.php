    ...
    <div class="content">
        ...
        <div class="main-content">
            <div class="slideshow-container" style="width: 90%; box-sizing: border-box;">
                ...
                <div  style="background-color: #222831; height: 50px; color: white; border-radius: 5px; font-size: 15px;" class="footer"><p style="margin-left:300px; margin-bottom: -30px;">Copyright © 2020 Sipetcare. All Rights Reserved
                    </p></div>
            </div>
        </div>
    </div>
