...
if($foto != "") {
    ...
    if(in_array($ekstensi, $ekstensi_diperbolehkan) === true)  {
        ...
        if(!$result){
            ...
            echo "<script>alert('Data berhasil diubah.');window.location='data_hewan_detail.php';</script>";
        }

    } else {
        //kalau file ekstensi tidak jpg dan png maka alert ini ditampilkan
        echo "<script>alert('Ekstensi gambar yang boleh hanya jpg atau png.');window.location='data_hewan_detail.php';</script>";
    }
} else {
