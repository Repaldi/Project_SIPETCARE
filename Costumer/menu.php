...
?>
    ...
    <div class="group-menu">
        ...
        <a href='#'><i class="fa fa-bug"></i> Data Hewan</a>
        <a href='#'><i class="fa fa-users" aria-hidden="true"></i> Jasa Penitipan </a>
        <a href='#'><i class="fa fa-users" aria-hidden="true"></i> Transaksi </a>
        <a href='#'><i class="fa fa-fax" aria-hidden="true"></i> Bantuan </a>
...
<?php }else{?>
    ...
    <div class="group-menu">
        ...
        <a href='data_transaksi.php'><i class="fa fa-users" aria-hidden="true"></i> Transaksi </a>
